...
import { lbl, korttia, shuffle, aiShouldFumble, truncName, shuffledAINames, lblColored, BOT_RESULT_DELAY } from '../shared/helpers.js';
  ...
  return (
    <div style={{ background: C.bg, fontFamily: 'Georgia,serif', color: C.text, padding: isMobile ? '6px 8px' : '14px 16px', maxWidth: 580, margin: '0 auto', paddingBottom: isMobile ? 8 : 32, overflowX: 'hidden' }}>
      ...
      <GameStatusBar
        ...
        isMobile={isMobile}
      >
        <span style={{ color: C.gold, fontWeight: 700 }}>{t('ui.shared.goal')}</span> {t('games.paskahousu.ui.goal')}
      </GameStatusBar>
